...
<body>
  ...
  <form action="admission2.php" method="post" class="all">
      ...
      <div class="table">
        <table>
          ...
          <tr>
            ...
            <th>:</th>
            <td colspan="2">
              <input type="radio" id="m" name="ggender" value="Male" required>
              <label for="m">Male || </label>
              <input type="radio" id="f" name="ggender" value="Female" required>
              <label for="f">Female || </label>
              <input type="radio" id="o" name="ggender" value="Other" required>
      ...
      <div class="table">
        <table style="margin-bottom: 20px;">
          ...
          <tr>
            ...
            <th>:</th>
            <td colspan="2"><input type="text" name="fammount" disabled="disabled"></td>
          </tr>
          <tr>
            <th><p>Fee Fully Paid</p></th>
            <th>:</th>
            <td colspan="2">
              <input type="radio" id="yes" name="paid" value="Paid" required>
              <label for="yes">Yes || </label>
              <input type="radio" id="no" name="paid" value="Unpaid" required>
          ...
          <tr>
            <th><p>Chalan</p></th>
            <th>:</th>
            <td colspan="2"><input type="number" name="chalan" disabled="disabled"></td>
          </tr>
        </table>
      </div>
    </div>
